...
class GPUModelRunner(
    ...
    def __init__(
        ...
        if self.pcp_world_size > 1:
            ...
            # Post-division buffer: GPU tensors (input_ids, positions, etc.)
            # Only CP requests need DualChunkSwap padding
            max_buffer_num_tokens = (
                self.max_num_tokens + num_cp_seqs * 2 * self.dycp_world_size
            )
