...
class GPUModelRunner(
    ...
    def __init__(
        ...
        self.decode_query_start_loc = self._make_buffer(
            self.max_num_reqs + 1, dtype=torch.int32
        )
    ...
    def _prepare_inputs(
        ...
        # Preserve request-level scheduled lengths before CP token repartition.
        self.decode_query_start_loc.np[0] = 0
        self.decode_query_start_loc.np[1 : num_reqs + 1] = cu_num_tokens
        self.decode_query_start_loc.np[num_reqs + 1 :].fill(cu_num_tokens[-1])
    ...
    def _build_attention_metadata(
        ...
        cm_base = CommonAttentionMetadata(
            ...
            decode_query_start_loc_cpu=self.decode_query_start_loc.cpu[
                : num_reqs_padded + 1
            ],
