...
class CommonAttentionMetadata:
    ...
    decode_query_start_loc_cpu: torch.Tensor | None = None
    """Optional request-level query starts before CP token repartition."""
    ...
    def unpadded(
        ...
        return CommonAttentionMetadata(
            ...
            decode_query_start_loc_cpu=(
                self.decode_query_start_loc_cpu[: num_actual_reqs + 1]
                if self.decode_query_start_loc_cpu is not None
                else None
            ),
...
def split_decodes_and_prefills(
    ...
    num_tokens = common_attn_metadata.num_actual_tokens
    query_start_loc = (
        common_attn_metadata.decode_query_start_loc_cpu
        if common_attn_metadata.decode_query_start_loc_cpu is not None
