    ...
    dict(abbr='gsm8k',
        ...
        infer_cfg=dict(
            ...
            prompt_template=dict(
                template=dict(
                    round=[
                        dict(prompt='Answer the following question.The last line of the response should follow this format: "answer:$ANSWER" (without quotes), where ANSWER is a number. Let\'s think step by step.\n\nQuestion: {question}',
                            role='HUMAN'),
                        ]),
...
eval=dict(
    partitioner=dict(
        out_dir='outputs/default/20260422_190541/results/',
...
infer=dict(
    partitioner=dict(
        out_dir='outputs/default/20260422_190541/predictions/',
        type='ais_bench.benchmark.partitioners.naive.NaivePartitioner'),
    runner=dict(
        debug=True,
        max_num_workers=1,
...
work_dir='outputs/default/20260422_190541'